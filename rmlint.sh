...
# rmlint was executed from: /run/media/vainilie/Docs/MyProjects/board/
...
original_cmd  '/run/media/vainilie/Docs/MyProjects/board/board1.json' # original
remove_cmd    '/run/media/vainilie/Docs/MyProjects/board/board.json' '/run/media/vainilie/Docs/MyProjects/board/board1.json' # duplicate
...
then                                           
  ...
  rm -f '/run/media/vainilie/Docs/MyProjects/board/rmlint.sh';                                     
fi                                             
